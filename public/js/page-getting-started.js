        ...
        model: {
            ...
            setupViewLink: function() {
                ...
                viewTemplate.onclick = function() {
                    ...
                    var iframe = '<style>*{margin:0;padding:0}</style><iframe src="' + url  + '" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%;" allowfullscreen></iframe>';
                    var win = window.open();
